...
#                 'Kidney Tumor', 'Liver Tumor', 'Pancreas Tumor', 'Hepatic Vessel Tumor', 'Lung Tumor', 'Colon Tumor', 'Kidney Cyst',"artery",'vein']
...
ORGAN_NAME_flare = [
            ...
            ####msd####
            ###amos####
            "Spleen tumor, Right kidney tumor, Left kidney tumor,\
            Gallbladder tumor, Esophagus tumor, Liver tumor, \
            Stomach tumor, Aorta tumor,Postcava tumor, Pancreas tumor, Right Adrenal Gland tumor, \
...
THRESHOLD_DIC = {
    ...
    # 'artery': 0.5,
    # 'vein': 0.5,
    'Novel Coronavirus Pneumonia': 0.5,
    "Kidney lesions and Bone lesions and Pulmonary nodules and Swollen lymph nodes": 0.5,
    "Kidney Tumor and Kidney Cyst": 0.5,
    "Lung nodules": 0.5,
    "Adrenocortical carcinoma": 0.5 , ## Adrenal 肾上腺皮质癌
    "mediastinal lymph-nodes and celiac lymph node": 0.5, ##  Lymph nodes 腹部和纵隔淋巴结
    "Non-small cell lung cancer and  Pleural effusion": 0.5,  ## 非小细胞肺癌 胸腔积液
    "whole body cancer or tumor": 0.5,
    ####msd####
    "colon Tumor": 0.5,
    "pancreas Tumor": 0.5,
    "Hepatic Vessel Tumor": 0.5,
    ...
    Gallbladder tumor, Esophagus tumor, Liver tumor, \
    Stomach tumor, Aorta tumor,Postcava tumor, Pancreas tumor, Right Adrenal Gland tumor, \
    Left Adrenal Gland tumor, Duodenum tumor, Bladder tumor, and Prostate/Uterus tumor": 0.5,
    ###amos####
    "abdominal trauma with visceral organ injury and internal bleeding, including liver, spleen, kidneys, and intestines ": 0.5
}
