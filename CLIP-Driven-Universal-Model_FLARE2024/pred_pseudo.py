...
def validation(model, ValLoader, val_transforms, args):
    ...
    for index, batch in enumerate(tqdm(ValLoader)):
        ...
        # organ_list = [i for i in range(1,33)]  ###original

        organ_list = [i for i in range(26,33)]  ###using for flare2024
...
def main():
    ...
    ## model load
    parser.add_argument('--resume', default='/pub/data/yangdeq/CLIP/pretrained_weight/unet.pth', help='The path resume from checkpoint')
    ...
    ## dataset
    parser.add_argument('--data_root_path', default="/pub/data/yangdeq/Flare2024/Validation-Hidden", help='data root path')
    parser.add_argument('--result_save_path', default="/pub/data/yangdeq/Flare2024/validation_infer_clip_unet", help='path for save result')
